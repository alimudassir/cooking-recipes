package com.maverick.cookingrecipes.bootstrap;

import com.maverick.cookingrecipes.models.*;
import com.maverick.cookingrecipes.repositories.CategoryRepository;
import com.maverick.cookingrecipes.repositories.RecipeRepository;
import com.maverick.cookingrecipes.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        recipeRepository.saveAll(getNewRecipes());
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setSource("Bawarchi Hotel");
        guacRecipe.setUrl("m.google.com");
    ...
    private List<Recipe> getNewRecipes() {
        ...
        //Yummy Guac
        Recipe guacRecipe = new Recipe();
        guacRecipe.setDescription("Chicken Biryani");
        guacRecipe.setPrepTime(20);
        guacRecipe.setCookTime(20);
        guacRecipe.setDifficulty(Difficulty.HARD);
        guacRecipe.setDirections("1 Cut chicken in one inch pieces. Boil rice and set aside. Heat oil in a non-stick pan, add cinnamon, bay leaves, cloves, cumin seeds, green cardamoms and sauté for half a minute." +
                "\n" +
                "2 Add sliced onions and sauté. Add slit green chillies and chicken cubes and continue to sauté. Add turmeric powder and mix. Add tomatoes and salt and mix. Add ginger-garlic paste, red chilli powder and yogurt. Mix well. " +
                "\n" +
                "3 Add half the fried brown onions. Add the boiled rice on top. Sprinkle garam masala powder, ginger strips, mint leaves and coriander leaves. Sprinkle milk, rose water and remaining browned onions." +
                "\n" +
                "4 Cover and cook on low heat for about ten minutes. Garnish with the egg slices and serve hot." +
                "\n" +
                "\n" +
                "Read more: https://www.sanjeevkapoor.com/Recipe/Chicken-Biryani-KhaanaKhazana");

        Notes guacNotes = new Notes();
        guacNotes.setRecipeNotes("Just serve it piping hot essentially with a raita and salad or kachumber and wait for all the praises coming your way! I would also suggest trying out this recipe of Brown Rice Biryani with Chutney Chicken");
        guacNotes.setRecipe(guacRecipe);
        guacRecipe.setNotes(guacNotes);

        guacRecipe.getIngredients().add(new Ingredient("Boneless chicken", new BigDecimal(2), eachUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"), teapoonUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tableSpoonUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tableSpoonUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal(2), eachUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("Basmati rice", new BigDecimal(2), tableSpoonUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("freshly grated black pepper", new BigDecimal(2), dashUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(".5"), eachUom, guacRecipe));
        ...
        //Yummy Tacos
        Recipe tacosRecipe = new Recipe();
        tacosRecipe.setDescription("Kadai Paneer");
        tacosRecipe.setCookTime(15);
        tacosRecipe.setPrepTime(10);
        tacosRecipe.setDifficulty(Difficulty.MODERATE);

        tacosRecipe.setDirections("1 Heat ghee in a kadai and saute the cottage cheese pieces till golden brown. Soak them in 5 cups water.\n" +
                "2 In the same pan add bay leaf, cloves, cinnamon sticks, onion paste and ginger garlic paste. Saute well till lightly golden.\n" +
                "\n" +
                "3 Add red chilli powder, coriander powder, turmeric powder, garam masala and little water. Mix well and allow the mixture to boil. Add tomato puree and mix again.\n" +
                "4 Cover and cook for five minutes till oil surfaces.Add salt and drained cottage cheese pieces. Garnish with coriander leaves and serve hot.\n" +
                "\n" +
                "\n" +
                "Read more: https://www.sanjeevkapoor.com/Recipe/Kadai-Paneer");

        Notes tacoNotes = new Notes();
        tacoNotes.setRecipeNotes("If you like your paneer in a spicy chatpata masala then kadai paneer recipe is custom made for you. Chunks of pan fried cottage cheese and cubes of tomato and green capsicum cooked in a delicious bhuna onion and tomato masala."+
                "\n" +
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Olive Oil", new BigDecimal(2), tableSpoonUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("boneless chicken thighs", new BigDecimal(4), tableSpoonUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Paneer (cottage cheese)", new BigDecimal(8), eachUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("packed baby arugula", new BigDecimal(3), cupsUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("medium ripe avocados, slic", new BigDecimal(2), eachUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("radishes, thinly sliced", new BigDecimal(4), eachUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("cherry tomatoes, halved", new BigDecimal(".5"), pintUom, tacosRecipe));
